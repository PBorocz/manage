...
** Inspiration:
   - [[https://github.com/tfeldmann/organize/blob/main/manage.py][organize/manage.py at main · tfeldmann/organize · GitHub]]
   - [[https://github.com/casey/just][GitHub - casey/just: 🤖 Just a command runner]]
** Design:
...
** Installation
   ...
   - ~python manage check~
   You'll note a manage.yaml file in the top-level directory so yes, I do eat my own dog-food.
** Critical Assumptions
   To the degree that your development/release environment stray from mine, the tool becomes less and less relevant to you!
*** Tools

...
- [TODO] Convert using git python API/library instead of command-line git?
...
- CHANGED: Moved up to python 3.11 (3.11.3 specifically) to take advantage of built-in TOML support.
